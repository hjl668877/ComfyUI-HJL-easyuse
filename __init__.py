...
from .h3_two_pass_long_time_v2 import NODE_CLASS_MAPPINGS as _HJL_TWO_PASS_LONG_TIME_V2

NODE_CLASS_MAPPINGS = {**_HJL_CORE, **_HJL_TWO_PASS, **_HJL_TWO_PASS_LONG_TIME_V2}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "H3_TwoPassSamplerLongTimeV2": "H3 Two-Pass Long Time V2 (HJL)",
}
